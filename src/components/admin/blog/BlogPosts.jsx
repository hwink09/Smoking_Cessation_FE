...
const BlogPosts = () => {
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {formData.image && (
        <img
          src={formData.image}
          alt="Xem trước"
          style={{ marginTop: 12, width: "100%", height: 160, objectFit: "cover", borderRadius: 8 }}
      ...
      <div>
        ...
        <div style={{ maxHeight: 160, overflowY: "auto", border: "1px solid #e5e7eb", borderRadius: 8, padding: 12 }}>
          {tags.map((tag) => (
  ...
  if (loading && blogs.length === 0) {
    return <div style={{ minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center" }}><Spin size="large" tip="Đang tải..." /></div>;
  }

  if (error) {
    return <div style={{ minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center", color: "#ff4d4f" }}>{error}</div>;
  }
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: 24 }}>
        {blogs.map((blog) => (
          <Card
            ...
            actions={[
              <Button type="link" danger icon={<DeleteOutlined />} onClick={() => { setBlogToDelete(blog._id); setShowConfirm(true); }} key="delete">Xoá</Button>,
            ]}
          >
              ...
              <Card.Meta
                ...
                description={
                  <>
                    ...
                    <div style={{ color: "#888", minHeight: 48, overflow: "hidden", textOverflow: "ellipsis" }}>{blog.content}</div>
                    ...
                    <div style={{ display: "flex", gap: 16, fontSize: 13, color: "#888", marginTop: 12 }}>
