...
const TasksManager = ({
  ...
  // Đảm bảo fetchTasksByStageId không đổi reference bằng useRef
  const fetchTasksByStageIdRef = React.useRef(fetchTasksByStageId);
  useEffect(() => {
    fetchTasksByStageIdRef.current = fetchTasksByStageId;
  }, [fetchTasksByStageId]);
  ...
  const loadTasks = React.useCallback(async () => {
    ...
    setLoading(true);
    try {
      const result = await fetchTasksByStageIdRef.current(stageId);
